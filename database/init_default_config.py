...
3.- La Garantía está en cada ítem (aplican condiciones)."""
    ...
    configs = [
        ...
        ('impuesto_internacional_options', default_impuesto, 'Opciones de impuesto internacional (%)'),
        ('profit_factors', default_utilidad, 'Factores de utilidad para cálculo de precios'),
